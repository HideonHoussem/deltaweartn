            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-8">
              {items.length === 0 ? (
                ...
                <>
                  ...
                  {/* Discount Offer */}
                  {!hasDiscount ? (
                    <div className="bg-[var(--accent)]/5 border border-[var(--accent)]/20 p-5 rounded-xl flex flex-col gap-4">
                       <div className="space-y-1">
                         <p className="text-[14px] font-bold text-black/90 flex items-center gap-2">
