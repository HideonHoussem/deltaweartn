...
export function WhatsAppButton() {
  ...
  return (
    <a
      href={`https://wa.me/${WA_NUMBER}?text=Hello! I have a question about DeltaWear products.`}
      target="_blank"
    ...
    >
      ...
      >
        ...
        <div className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-1/2 rotate-45 w-2 h-2 bg-white" />
      </div>
      ...
      {/* Pulse animation */}
      <div className="absolute inset-0 w-14 h-14 bg-[#25D366] rounded-full animate-ping opacity-30" />
    </a>
  )
}
